...
const SvgComponent = (props) => (
  ...
  >
    <path
      ...
      className="elementor-shape-platform"
      opacity={0.33}
    />
    <path
    ...
    />
    <path
      d="M766.1 28.9c-200-57.5-266 65.5-395.1 19.5-129-46.6-129-43-186.2-27.8-56.8 15.2-52.5 24.3-94.9 31.9C28.6 63.7 0 0 0 0h1000s-9.9 40.9-83.6 48.1-86.8-1.1-151.3-19.2z"
    />
  </svg>
)
